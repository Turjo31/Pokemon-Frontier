...
@push('styles')
    <style>
        ...
        .t-grass {
            background: rgba(82, 196, 90, 0.18);
            color: #7dce83;
        }
        ...
        .t-psychic {
            background: rgba(224, 64, 140, 0.18);
            color: #e87bbf;
        }
        ...
        .t-poison {
            background: rgba(176, 108, 208, 0.18);
            color: #cc99e6;
        }
        ...
        .t-ghost {
            background: rgba(96, 96, 200, 0.18);
            color: #9999dd;
        }

        .t-ice {
            background: rgba(122, 212, 232, 0.18);
            color: #8ddae8;
        }

        .t-flying {
            background: rgba(128, 174, 232, 0.18);
            color: #99bfe0;
        }

        .t-bug {
            background: rgba(144, 192, 64, 0.18);
            color: #aad455;
        }

        .t-rock {
            background: rgba(187, 160, 96, 0.18);
            color: #ccaa66;
        }
        ...
        .t-fighting {
            background: rgba(224, 80, 64, 0.18);
            color: #e07766;
        }

        .t-steel {
            background: rgba(154, 176, 192, 0.18);
            color: #aabfcc;
        }

        .t-dark {
            background: rgba(167, 128, 112, 0.18);
            color: #b89988;
        }
        ...
        .toast.success {
            border-color: rgba(82, 196, 90, 0.4);
            color: #7ee382;
        }

        .toast.error {
            border-color: rgba(232, 55, 42, 0.4);
            color: #ff7c72;
        }
            ...
            <div class="poke-grid" id="poke-grid">
                @forelse($pokemon as $i => $p)
                    @php
                        ...
                        $sprite = $p['sprite'] ?? '?';
                    @endphp
                    <div class="poke-tile" data-id="{{ $p['id'] ?? $i }}" data-name="{{ $p['name'] }}"
                        data-sprite="{{ $sprite }}" data-power="{{ $total }}" data-types="{{ implode(',', $types) }}"
                        data-namelo="{{ strtolower($p['name']) }}" style="animation-delay:{{ $i * 0.02 }}s"
