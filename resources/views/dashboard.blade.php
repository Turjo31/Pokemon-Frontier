...
<style>
    ...
    .match-names { flex: 1; }
    .match-winner { font-weight: 500; color: var(--text); }
    .match-vs     { font-size: 11px; color: var(--muted); margin-top: 1px; }
    ...
    .badge-win  { background: rgba(82,196,90,0.12);  color: #7ee382; }
    .badge-loss { background: rgba(232,55,42,0.1);   color: #ff7c72; }
    ...
    .rank-row.you { background: rgba(245,200,66,0.04); }
    ...
    .rank-record{ font-size: 11px; color: var(--muted); }
    .rank-pts   { font-family: var(--display); font-size: 15px; color: var(--accent2); }
    ...
    .tb-meta { font-size: 11px; color: var(--muted); margin-top: 3px; }

    .tb-arrow { color: var(--muted); font-size: 18px; }
    ...
    .dash-grid .panel:nth-child(1) { animation-delay: 0.20s; }
    .dash-grid .panel:nth-child(2) { animation-delay: 0.25s; }
...
<div class="page-header animate-in">
    ...
    <div class="page-sub">Welcome back, Trainer — Season 1 is active</div>
</div>
            ...
            @forelse($recentMatches ?? [] as $match)
                ...
                <div class="match-row">
                    ...
                    <div class="match-score">
                        ...
                        {{ $won ? $match->opp_score : $match->my_score }}
                    </div>
