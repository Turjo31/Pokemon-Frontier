...
<style>
    ...
    .section-panel:nth-child(2) { animation-delay: 0.06s; }
    ...
    .btn-small-add:hover { background: #cc2e22; }
    ...
    .status-upcoming { background: rgba(255,255,255,0.06); color: var(--muted); border: 1px solid var(--border); }
    ...
    .status-full     { background: rgba(232,55,42,0.1); color: #ff7c72; border: 1px solid rgba(232,55,42,0.2); }
    ...
    .btn-icon:hover { color: var(--accent2); border-color: rgba(245,200,66,0.3); }
    .btn-icon.danger:hover { color: #ff7c72; border-color: rgba(232,55,42,0.3); }
    ...
    .btn-simulate:hover { background: rgba(245,200,66,0.18); }
    ...
    .empty-item-icon { font-size: 28px; opacity: 0.3; margin-bottom: 8px; }
    ...
    .btn-cancel {
        ...
        font-family: var(--body); cursor: pointer; transition: all 0.15s;
    }
            ...
            @forelse($tournaments ?? [] as $t)
                <div class="item-row">
                    ...
                    <div class="item-info">
                        ...
                        <div class="item-meta">
                            {{ $t['league_name'] ?? '—' }} · {{ $t['registered'] ?? 0 }}/{{ $t['max_participants'] ?? 16 }} trainers
                        </div>
                    </div>
...
<div class="modal-overlay" id="league-modal">
    <div class="modal">
        ...
        <form method="POST" action="#" id="league-form">
            @csrf
