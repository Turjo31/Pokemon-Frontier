...
<head>
    ...
    <title>Register — Pokémon Frontier</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .step.done .step-num  { background: rgba(245,200,66,0.15); color: var(--accent2); border: 1px solid rgba(245,200,66,0.3); }
        .step.done .step-text { color: var(--muted); }
        .step.active .step-num  { background: var(--accent2); color: #111; }
        .step.active .step-text { color: var(--text); }
        .step.idle .step-num  { background: rgba(255,255,255,0.05); color: var(--muted); border: 1px solid var(--border); }
        .step.idle .step-text { color: var(--muted); }
        ...
        .strength-bar.weak   { background: #e8372a; }
        .strength-bar.medium { background: #f5c842; }
        .strength-bar.strong { background: #52c45a; }
...
<div class="card">
    <div class="card-title">Join the frontier</div>
    <div class="card-sub">Register your trainer account to start competing</div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="field">
            ...
            >
            <div class="field-hint">This is your public display name</div>
        </div>
        ...
        <label class="terms">
            ...
            <span>I agree to compete fairly and accept the Pokémon Frontier rules</span>
        </label>

        <button type="submit" class="btn-submit">Create trainer account</button>
